...
public class HelloWorld extends PApplet
{
	...
	public void setup() {
		size(1200, 600, P2D);  // Set up the Applet window to be 800x600
		...
		map1 = new UnfoldingMap(this, 50, 100, 350, 600, provider); //(this,x,y,width, height
		map2 = new UnfoldingMap(this, 600, 50, 350, 500, provider);
		// The next line zooms in and centers the map at 
	    // 32.9 (latitude) and -117.2 (longitude)
	    map1.zoomAndPanTo(zoomLevel, new Location(32.9f, -117.2f));
	    map2.zoomAndPanTo(zoomLevel, new Location(43.55f, -79.74f));
